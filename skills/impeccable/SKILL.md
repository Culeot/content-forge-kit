...
description: |
  ...
  中文:用户想要设计、重设计、塑造、批判、审查、打磨、澄清、蒸馏、加固、优化、适配、动效、上色、提取或以其他方式改进前端界面时使用。覆盖网站、落地页、仪表盘、产品 UI、应用壳、组件、表单、设置、引导页、空状态。处理 UX 审查、视觉层级、信息架构、认知负荷、无障碍、性能、响应式、主题、反模式、排版、字体、间距、布局、对齐、颜色、动效、微交互、UX 文案、错误状态、边界情况、i18n、可复用设计系统/token。也用于需要更醒目或更沉稳的设计、UI 元素的实时浏览器迭代、以及追求技术非凡的视觉特效。不用于纯后端或非 UI 任务。
version: 4.0.4
---
